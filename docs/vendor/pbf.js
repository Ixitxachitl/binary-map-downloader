// Vendored verbatim from pbf 5.1.2 (https://github.com/mapbox/pbf) - BSD-3-Clause,
// Copyright (c) 2015, Konstantin Kaefer. Only PbfReader is used here (MVT decoding is
// read-only); PbfWriter is kept for provenance/future use but is dead code today.
